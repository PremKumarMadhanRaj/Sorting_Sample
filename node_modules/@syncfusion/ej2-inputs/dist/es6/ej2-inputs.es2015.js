...
let SignatureBase = class SignatureBase extends Component {
    constructor() {
        super(...arguments);
        this.minDistance = 5;
        this.previous = 0;
    ...
    keyboardHandler(e) {
        const args = { fileName: 'Signature', type: 'png' };
        switch (e.keyCode) {
            case 46:
                this.clear();
                break;
            case (17 && 83):
                this.trigger('beforeSave', args, (observedChangeArgs) => {
    ...
    save(type, fileName) {
        ...
        type = type || 'png';
        const dataURL = this.canvasContext.canvas.toDataURL('image/' + type);
...
__decorate$7([
    Property('')
], Signature.prototype, "cssClass", void 0);
__decorate$7([
    Property(false)

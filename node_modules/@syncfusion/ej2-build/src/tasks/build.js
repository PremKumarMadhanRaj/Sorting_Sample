...
gulp.task('scripts', preScript, function (done) {
    runSequence('scripts-gen', 'e2e-helper-scripts', done);
});
...
gulp.task('build', function (done) {
    ...
    runSequence('styles-all', 'scripts', done);
});

// React build task.
gulp.task('es-build', function (done) {
    runSequence('styles-all', 'create-model', 'scripts-gen', 'e2e-helper-scripts', done);
});

$grid-content-padding: 10px !default;
$grid-headecell-height: 30px !default;
...
$grid-headercelldiv-line-height: 23px !default;
$grid-bigger-headercelldiv-line-height: 1.5 !default;
...
$grid-textwrap-srotnumber-rightalign-margin: 3px 2px 0 10px !default;
...
$grid-columnchooser-btn-font-size: 18px !default;
...
$grid-column-chooser-search-icon-padding: 0 5px !default;
...
$grid-rtl-bigger-sortnumber-margin: 5px 0 0 36px !default;
...
$grid-bigger-headercell-bootom-padding: 0 !default;
$grid-bigger-grightarrow-icon-font-size: 22px !default;
...
$grid-bigger-ungroup-button-font-size: 22px !default;
$grid-bigger-group-text-line-height: .2em !default;
$grid-bigger-groupcaption-line-height: 32px !default;
$grid-bigger-rtl-group-headercell-margin: 16px 24px 0 0 !default;
$grid-bigger-rtl-group-headercell-padding: 4px 6px 4px 9px !default;
$grid-bigger-rtl-ungroup-icon-margin-top: 6px !default;
$grid-bigger-rtl-ungroup-icon-margin-right: -20px !default;
...
$grid-resize-helper-color: $border-light !default;
...
$grid-icon-font-size: 18px !default;
...
$grid-rowcell-line-height: 1 !default;
...
$grid-sortnumber-margin: 3px 2px 0 8px !default;
$grid-sortnumber-rightalign-margin: 4px 8px 0 15px !default;
$grid-sortnumer-line-height: 16px !default;
$grid-sortdiv-right-align-margin: -28px -5px !default;
$grid-sortdiv-margin:  -28px -4px !default;
...
$grid-grouparea-margin: 11px 0 0 8px !default;
$grid-group-headercell-line-height: 25px !default;
$grid-grouped-headercell-padding: 3px 0 !default;
$grid-grouped-headercell-span-padding: 1.5px 8px !default;
...
$grid-group-down-arrow-icon-font-size: 16px !default;
...
$grid-group-right-arrow-icon-font-size: 16px !default;
...
$grid-rtl-sortnumber-margin: 2px 0 0 15px !default;
$grid-rtl-sortnumber-rightalign-margin: 3px 0 0 31px !default;
$grid-rtl-sortcelldiv-margin: -29px 10px !default;
$grid-rtl-sortcelldiv-right-align-margin: -29px 10px !default;
$grid-rtl-bigger-sortcelldiv-right-align-margin: -33px 22px !default;
...
$grid-rtl-headercelldiv-padding: 0 .4em 0 1.8em !default;
$grid-ungroup-rtl-padding-right: -18px !default;
...
$grid-bigger-rowcell-line-height: 1 !default;
$grid-bigger-font-size: 16px !default;
$group-unpgrouicon-margin-left: -18px !default;
...
$grid-bigger-content-padding: 13.5px !default;
...
$grid-bigger-group-headercell-margin: 17.5px 0 0 8px !default;
...
$grid-bigger-ungroupbutton-icons-font-size: 18px !default;
$grid-bigger-groupcell-span-padding: 8px 4px 14px 12px !default;
$grid-bigger-ungroupbutton-icon-margin-left: -18px !default;
$grid-bigger-ungroupbutton-icon-margin-top: -1px !default;
$grid-bigger-groupcell-span-line-height: .45em !default;
$grid-bigger-gdownarrow-icon-font-size: 22px !default;
...
$grid-bigger-columnchooser-btn-font-size: 22px !default;
...
$grid-headercelldiv-fltricon-margin: -5px !default;
...
$grid-fltrdiv-margin: -20px -7px !default;
$grid-rtl-fltrdiv-margin: -20px 0 -20px -36px !default;
$grid-rtl-bigger-fltrdiv-margin: -21px 0 -18px -10px !default;
$grid-bigger-rtl-headercelldiv-fltricon-padding: -5px -10px -5px 0 !default;
$grid-bigger-fltrdiv-margin: -23px -6px !default;
$grid-sortdiv-filtericon-margin: -29px 34px -29px 0 !default;
$grid-sortdiv-filtericon-rightalign-margin: -29px -11px -5px -5px !default;
$grid-rtl-sortdiv-filtericon-rightalign-margin: -29px -4px 0 16px !default;
$grid-rtl-sortdiv-filtericon-margin: -29px -4px 0 16px !default;
...
$grid-rtl-bigger-fltricon-sortdiv-margin: -30px 0 0 14px !default;
$grid-rtl-bigger-fltricon-sortdiv-rightalign-margin: -29px 0 0 18px !default;
...
$grid-column-menu-margin: -19px -18px -3px -19px !default;
...
$grid-column-menu-right-touch: 10px !default;
...
$grid-header-wrap-filtericon-sortfilter-div-margin: -27px 20px -29px 0 !default;
...
$grid-header-wrap-filtericon-rightalign-sortfilter-div-margin: -28px 0 !default;
$grid-drag-font-size: 16px !default;
...
$grid-bigger-sortnumber-rightalign-margin: 4px 0 0 15px !default;
$grid-bigger-columnmenu-bottom: 13px !default;
$grid-bigger-sortnumber-margin: 4px 18px 0 2px !default;
...
$grid-bigger-font-size: 16px !default;
$grid-rtl-bigger-rightalign-fltrdiv-margin: -20px 0 -18px -42px !default;
...
$grid-rtl-column-menu-margin: -20px -18px -1px -22px !default;
...
$grid-responsive-custom-header-btn-color: $grid-filtered-color;
...
$grid-responsive-filter-reset-color: $grid-filtered-color;
$grid-responsive-toolbar-icon-color: $grid-icon-color;
$grid-responsive-close-icon-color: $grid-icon-color;
...
$grid-responsive-search-place-holder-margin-top: 2px !default;
...
$grid-responsive-btn-top: -12px !default;
...
$grid-bigger-rtl-cm-margin: -20px -18px -5px -22px !default;
$grid-bigger-rtl-group-span-padding: 9.5px 4px 14px 12px !default;
$grid-rtl-group-span-padding: 1.5px 4px 14px 12px !default;
